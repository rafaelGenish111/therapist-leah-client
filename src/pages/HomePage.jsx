...
const HomePage = () => {
  ...
  const testimonials = [
    {
      name: "רחל כהן",
      text: "ליאה פשוט קסומה! אחרי מספר טיפולים הכאבים בגב נעלמו לחלוטין. מקצועיות ברמה גבוהה!",
      rating: 5,
      treatment: "עיסוי רקמות עמוקות"
    },
    {
      name: "דוד לוי",
      text: "המקום הכי מרגיע בתל אביב. ליאה יודעת בדיוק מה הגוף צריך. ממלץ בחום!",
      rating: 5,
      treatment: "עיסוי שוודי"
    },
    {
      name: "מירי אברהם",
      text: "טיפול מדהים במהלך ההריון. ליאה מבינה בדיוק איך לטפל בזמן מעין זה. תודה רבה!",
      rating: 5,
